...
public class TreatActivity_eyeright2 extends AppCompatActivity {
    ...
    public static Activity eyerightactivity;
    RenderScript rs;
    Bitmap blurBitMap;
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (countStart == 7) {
                            ...
                            // 여기서 고쵸
                            SharedPreferences sp_treat = getSharedPreferences("eye_r", MODE_PRIVATE);
                            SharedPreferences.Editor editor1 = sp_treat.edit();
                            editor1.putInt("eye_r", 0);
                            editor1.commit();

                            //Log.e("eyeright", "save");
                            if (! TreatActivity_eyeright2.this.isFinishing()) {
                                Intent intent = new Intent(getApplicationContext(),DoneActivity.class);
                                intent.putExtra("stringlist","eyeright");
    ...
    private void setDataTreat() {
        ...
        editor2.putString("tZone", treat+"/eye_r");
        editor2.commit();

        //Log.e("안희 좀...", treat+"/eye_r");

        setDataTreat tasks1 = new setDataTreat();
        tasks1.execute("http://"+HomeActivity.IP_Address+"/callingTreat.php", treat+"/eye_r");

        setData task = new setData();
        task.execute("http://"+HomeActivity.IP_Address+"/saveTreat.php", treat+"/eye_r");
    }
    ...
    class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String getResult) { // 모르겠어// 유...
            ...
            if (getResult.contains("No_results")) {
                setData task = new setData();
                task.execute("http://"+HomeActivity.IP_Address+"/saveTreat.php", "eye_r");
                ...
                setData task = new setData();
                task.execute("http://"+HomeActivity.IP_Address+"/updateTreat.php", treat+"/eye_r");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eyerightactivity=TreatActivity_eyeright2.this;
    ...
    public void onResume() {
        ...
        SharedPreferences sp_treat = getSharedPreferences("eye_r", MODE_PRIVATE);
        countFin = sp_treat.getInt("eye_r", 0);
        setBack(countFin);
