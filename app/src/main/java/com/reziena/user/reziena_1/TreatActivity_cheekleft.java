...
public class TreatActivity_cheekleft extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.question_cl);
                ...
                switch (v.getId()) {
                    ...
                    case R.id.cheek_left_cl:
                        if (HomeActivity.isConn) {
                            ...
                            HomeActivity.whereTreat = "cheekleft";
                    ...
                    case R.id.cheek_right_cl:
                        if (HomeActivity.isConn) {
                            //HomeActivity.send("whatLevel?");
                            HomeActivity.whereTreat = "cheekright";
                            HomeActivity.countStart = 0;
                            ...
                            if (HomeActivity.diffCheck()) {
                                ...
                                intent = new Intent(getBaseContext(), DifLevelActivity.class);
                                //intent.putExtra("where", "cheekleft");
                                startActivity(intent);
                            }
                        } else {
                            intent = new Intent(getBaseContext(), BluetoothActivity.class);
