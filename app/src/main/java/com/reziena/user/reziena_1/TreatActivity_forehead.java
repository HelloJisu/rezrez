...
public class TreatActivity_forehead extends AppCompatActivity {
  ...
  ImageView forehead, underleft, underright, eyeleft, eyeright, cheekl, cheekr, mouth,question, backgroundimg;
        ...
        switch (v.getId()) {
          ...
          case R.id.forehead_f:
            if (HomeActivity.isConn) {
              ...
              HomeActivity.whereTreat = "forehead";
              ...
              if (HomeActivity.diffCheck()) {
                if (treatResult.contains("fore_r")&& !treatResult.contains("fore_l")) {
                  ...
                  intent = new Intent(getBaseContext(), TreatActivity_foreheadleft.class);
                  startActivity(intent);
                  finish();
                } else if (!treatResult.contains("fore_r")) {
  ...
  private void setResult() {
    ...
    if (level == 1) {
      ...
      if (treatResult.contains("fore_l")) {
        ...
        forehead.setImageResource(R.drawable.underleftdone);
      } else {
